...
public class MovieListTest {
  ...
  // movielist is type of interface since rule
  ...
  @Before public void setUp() {
    ...
    // when you create object you need to go concrete, empty constructor, list have nothing
  ...
  @Test public void testMoviesMadeBefore() {
    ...
    // FILTER for a sub-list, give me movies before 1964
