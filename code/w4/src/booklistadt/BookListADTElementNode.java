...
public class BookListADTElementNode implements BookListADTNode {
  ...
  public BookListADTElementNode(Book book, BookListADTNode rest) {
    this.book = book;
    this.rest = rest;
  }
  ...
  @Override public BookListADTNode addFront(Book book) {
    return new BookListADTElementNode(book, this);
  }

  @Override public BookListADTNode addBack(Book book) {
    this.rest = this.rest.addBack(book);
    return this;
  }

  @Override public BookListADTNode add(int index, Book book) {
    if (index == 0) {
  ...
  @Override public BookListADTNode remove(Book book) {
  ...
  @Override public Book get(int index) throws IllegalArgumentException {
    if (index == 0) {
      return this.book;
    }
