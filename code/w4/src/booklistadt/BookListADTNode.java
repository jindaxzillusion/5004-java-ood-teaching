...
/**
 * This interface represents all operations for a node in a list of books implemented as an ADT. The
 * advantage of the ADT design is that this interface may now represent operations on a single node,
 * instead of the IListOfBooks that represented nodes but the operations were really on lists.
 */
public interface BookListADTNode {
  ...
  /**
   * A method that adds the given book at the given index in this list . If index is 0, it means
   * this book should be added to the front of this list
   *
  ...
  /**
   * Get the book at the specified index, with 0 meaning the first book in this list
   *
