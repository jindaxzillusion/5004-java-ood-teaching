...
public class BookListADTTest {
  @Test public void testListADT() {
    ...
    assertEquals("(Title: HP 1 Author: J.K. Rowling Year: 1997 Price: 19.99)"
        + "(Title: HP 2 Author: J.K. Rowling Year: 1998 Price: 10.99)", list.toString());
    ...
    assertEquals("(Title: HP 1 Author: J.K. Rowling Year: 1997 Price: 19.99)"
        ...
        + "(Title: HP 4 Author: J.K. Rowling Year: 2001 Price: 15.99)", list.toString());
