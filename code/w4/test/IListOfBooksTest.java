...
public class IListOfBooksTest {
  ...
  @Before public void setup() {
    ...
    partialListOfBooks = new ElementNode(new Book("HP 1", "J.K. Rowling", 1997, 19.99f),
        new ElementNode(new Book("HP 2", "J.K. Rowling", 1999, 29.99f),
            new ElementNode(new Book("HP 3", "J.K. Rowling", 2001, 10.99f), new EmptyNode())));
  ...
  @Test public void testToString() {
    String expected = "(Title: HP 4 Author: J.K. Rowling Year: 2004 Price: " + "15.49)"
  ...
  @Test public void testTotalPrice() {
  ...
  @Test public void testAllBefore() {
  ...
  @Test public void testAllBeforeWithPredicate() {
  ...
  @Test public void testAllBeforeWithPredicate2() {
    int year = 2000;
  ...
  @Test public void testAllBeforeWithPredicate3() {
    int year = 2000;
  ...
  private class BookBefore implements Predicate<Book> {
    ...
    @Test public boolean test(Book b) {
      return b.getYear() < year;
    }
  }
